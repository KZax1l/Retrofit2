...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
  ...
  /*public*/ EventListener.Factory eventListenerFactory() {
    ...
    public static final class Builder {
         ...
         * <p>
         * 设置客户端Ping套接字间的时间间隔；使用该方法自动发送套接字执行Ping命令，直到失败或关闭；
         * 持续地保持连接可以更早地检测到连接失败
         */
         ...
         * be used.
         * <p>
         * 设置{@link SocketFactory}以便创建连接；OkHttp仅使用无参方法{@link SocketFactory#createSocket()}
         * 来创建无连接Sockets
         */
